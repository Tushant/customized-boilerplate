    ...
    return (
      <Modal className="modal-sm" show onHide={() => this.props.hideDialog()}>
        <Modal.Header closeButton>
          ...
          {confirmUserRequest.requesting &&
            <p>You confirmation is on progress</p>}
          {!confirmUserRequest.requesting &&
            confirmUserRequest.success &&
            <p>You confirmation is complete</p>}
          {!confirmUserRequest.requesting &&
            !confirmUserRequest.success &&
            <p>You confirmation ended in an error</p>}
        </Modal.Header>
      </Modal>
    );
  }
