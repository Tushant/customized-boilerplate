...
class PasswordReset extends React.PureComponent {
  ...
  handleSubmit = (e) => {
    ...
    if (this.isValid()) {
      ...
      let success = this.props.newPassword(Object.assign({}, {
  ...
  render() {
    ...
    return (
      <Modal className="modal-sm" show onHide={() => this.props.hideDialog()}>
        ...
        {confirmPasswordReset && confirmPasswordReset.errors && confirmPasswordReset.errors.alert_message && <p>{confirmPasswordReset.errors.data}</p>}
        {
          confirmPasswordReset && confirmPasswordReset.messages && confirmPasswordReset.messages.data &&
