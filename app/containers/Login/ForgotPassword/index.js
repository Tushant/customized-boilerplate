...
class ForgotPassword extends React.PureComponent {
  ...
  handleSubmit = (e) => {
    e.preventDefault();
    console.log('submitting. here we dispatch the given email to handleForgotPassword', this.props.forgotPassword);
  ...
  render() {
    ...
    return (
      ...
      <Modal show onHide={() => this.props.hideDialog()} className="modal-sm">
        ...
        {confirmForgotPassword.successful && <p>{confirmForgotPassword.messages.data}</p>}
