...
class MyHotels extends React.PureComponent {
  render() {
   ...
   <div className='block'><img src={add_hotel_full} alt="add_hotel_full" />
   </div>
...
<select className="form-control"><option>Hotel</option>
<option>Motel</option></select>
</div>
<div className="form-group">
...
<input type="text" className="form-control" />
<p className="note">We will call at the given number to verify.</p>
</div>
...
<button className="btn btn-default btn-block btn-lg">Submit Details</button>
